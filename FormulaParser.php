...
class FormulaParser implements IFormulaParser
{
    ...
    protected $valid_functions            = ['abs', 'sin', 'cos', 'tan', 'log', 'exp', 'sqrt', 'ceil','floor'];
    ...
    private function parse($str)
    {
        ...
        for ($i = 0; $i < $strlen; $i++)
        {
            ...
            $str_ip5 = (isset($str[$i + 5])) ? $str[$i + 5] : null;
            ...
            elseif ((in_array($str_i . $str_ip1 . $str_ip2, $this->valid_functions))
                || in_array($str_i . $str_ip1 . $str_ip2 . $str_ip3 ,$this->valid_functions)
                ||in_array($str_i . $str_ip1 . $str_ip2 . $str_ip3. $str_ip4 ,$this->valid_functions))
            {
                    ...
                    elseif ($str_ip4 == ' ')
                    {
                        $this->calculateFunction($str_i . $str_ip1 . $str_ip2 . $str_ip3, $str, $strlen, $i);
                    }
                    elseif ($str_ip5 == ' ')
                    {
                        $this->calculateFunction($str_i . $str_ip1 . $str_ip2 . $str_ip3. $str_ip4, $str, $strlen, $i);
                    }
                // Variable
            }
